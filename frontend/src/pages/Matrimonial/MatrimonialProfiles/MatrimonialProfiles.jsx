              ...
              {/* <div className="search-user-box-wrapper">
                ...
                <div className="search-box-description">
                  ...
                  <div className="search-user-more-info">
                    <div className="user-info">B.Sc</div>
                    <div className="user-info">IT Profession</div>
                    <div className="user-info">Cricket</div>
                    <div className="user-info">23 Year Old</div>
                  </div>
